subroutine read_params
  ...
  namelist/poisson_params/epsilon,gravity_type,gravity_params &
       & ,cg_levelmin,cic_levelmax,a0,a0_ms2,m_threshold,nu_function
  !~~~~~~~~~~ end ~~~~~~~~~~
  
  !-------New block added by STN -----!
  
  namelist/mond_disk_params/mass_disk,f_inner,f_outer,rd_inner,rd_outer,rmax 
...
81 continue
   rewind(1)
  read(1,NML=mond_disk_params,END=84) !-----STN ---!
84 continue
...
user_time_to_Myr = scale_t / 31557600.d+6
...
!~~~~~~~~~~ end ~~~~~~~~~~
   ...
   !-------------------STN----------------!
  write(*,*)'("Mass of the disk")',mass_disk/1.0d10, "Msun"
  write(*,*)'("Inner Rd")',rd_inner, "kpc"
  write(*,*)'("Outer Rd")',rd_outer, "kpc"
...
!    write(*,*)" Rho analytical is being called"
!end if 
