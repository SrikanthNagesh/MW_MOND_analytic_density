module pm_commons
  ...
  integer*4 :: i_end_M31, i_end_MW, unit_output_centres=274732523
  integer*4 :: i_end_M31_all, i_end_MW_all
  
  ! Particles related arrays
  real(dp),allocatable,dimension(:,:)::xp       ! Positions
  real(dp),allocatable,dimension(:,:)::vp       ! Velocities
  real(dp),allocatable,dimension(:,:)::accp     ! Accelerations added by IT 2016
