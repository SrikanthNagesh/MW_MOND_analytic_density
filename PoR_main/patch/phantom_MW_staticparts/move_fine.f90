subroutine move_fine(ilevel)
  ...
  !----------------------------------------------------------------------
  integer::igrid,jgrid,ipart,jpart,next_part,ig,ip,npart1,info,npart2
  ...
  do jgrid=1,numbl(myid,ilevel)
     ...
     if(npart1>0)then        
        ...
        !~~~~~~~~~ begin ~~~~~~~~~
        npart2=0 ! count particles with mp<m_threshold
        !~~~~~~~~~~ end ~~~~~~~~~~
        ...
        !~~~~~~~~~ begin ~~~~~~~~~
        ! IMPOTANT: If there are no particles with masses > m_threshold in this grid, 
        ! reset the grid counter (ig), i.e. decrease it by 1!
        ! Otherwise, it can happen that ig>NVECTOR!
        if (npart2==0) then
           ig=ig-1
        endif
        !~~~~~~~~~~ end ~~~~~~~~~~
