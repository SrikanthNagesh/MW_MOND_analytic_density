...
subroutine dump_all
  ...
  if (myid==1) write(*,*)'Entering dump_all'
  ...
  if(ndim>1)then
     ...
     if (myid==1) then
        print '(a,i2,a)','output_amr: Safety sleep for ',safety_secs,' secs...'
     endif
     call flush
     call sleep(safety_secs)!added by IT 2018-11-16
     !endif
